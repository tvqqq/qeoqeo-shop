...
if (!$checkout->is_registration_enabled() && $checkout->is_registration_required() && !is_user_logged_in()) { ?>
    <div id="login-form-popup">
        <div class="login-social">
            <p class="login-social-text-top"><?php _e('Order payment in just one step with:', 'flatsome') ?></p>
            <div class="login-social-button">
                <?php echo do_shortcode('[nextend_social_login provider="facebook"]'); ?>
                <span class="login-social-text-or">-<?php _e('or', 'flatsome'); ?>-</span>
...
<i class="fas fa-gift"></i> <?php do_action('woocommerce_before_checkout_form', $checkout) ?>
