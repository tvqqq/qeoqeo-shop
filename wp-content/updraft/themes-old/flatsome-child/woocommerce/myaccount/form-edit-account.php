...
<form class="woocommerce-EditAccountForm edit-account" action=""
    ...
    <fieldset>
        <legend><?php esc_html_e('Thông tin cơ bản', 'woocommerce'); ?></legend>
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-last">
            <label for="billing_phone"><?php _e('Mobile phone', 'flatsome'); ?> <span
                        class="required">*</span></label>
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
            ...
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text"
                   name="billing_address_1" id="billing_address_1" value="<?php echo esc_attr($user->billing_address_1); ?>"/>
        </p>
    </fieldset>

    <fieldset>
        <legend><?php esc_html_e('Liên kết tài khoản mạng xã hội', 'woocommerce'); ?></legend>
